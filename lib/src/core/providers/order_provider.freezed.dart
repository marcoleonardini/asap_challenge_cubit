...
// ignore: unused_element
  _Loaded loaded({@required List<OrderModel> ordersList}) {
    return _Loaded(
...
mixin _$OrderState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loaded(List<OrderModel> ordersList),
  ...
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult loading(),
    TResult loaded(List<OrderModel> ordersList),
    TResult error(),
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'OrderState.loaded(ordersList: $ordersList)';
  }
...
abstract class _Loaded implements OrderState {
  const factory _Loaded({@required List<OrderModel> ordersList}) = _$_Loaded;
